<template>
    <div class="container-fluid">
        <div class="row">
            <h5>Ikea showroom - Live preview</h5>
            <div class="live-preview">                
                    <div class="col-md-12">
                        <label class="stretch">Practice <i class="fa-solid fa-play"></i></label>
                        <iframe class="stretch" id="output"></iframe>
                    </div>
            </div>
                ...
                <div class="d-flex">
                    <div class="col-md-6">
                        <label for="">HTML <i class="fa-brands fa-html5"></i></label>
                            <textarea class="form-control" placeholder="html code" id="html-code" rows="20" @input="  enterPressed()" v-model="templateCode">
                    ...
                    <div class="col-md-6">
                        <label for="">CSS <i class="fa-brands fa-css3-alt"></i></label>
                            <textarea class="form-control" placeholder="Css code" id="css-code" rows="20" @input="  enterPressed()" v-model="stylingCode">
                    ...
                    <div class="col-md-6">
                        <label for="">JavaScript <i class="fa-brands fa-square-js"></i></label>
                             <textarea class="form-control" placeholder="js code" id="js-code" rows="20" @input="  enterPressed()" v-model="scriptCode">
